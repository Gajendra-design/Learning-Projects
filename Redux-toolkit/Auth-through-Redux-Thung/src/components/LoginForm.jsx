...
const LoginForm = () => {
  ...
  const {showPassword,setShowPassword,handelLogin,handleSubmit,register} = useAuth()
    ...
    <div className="border border-white rounded p-8">
      ...
      <form onSubmit={handleSubmit(handelLogin)} className="space-y-4">
        ...
        <div className="pt-1 text-xs text-slate-400">
          <span>New user? </span>
          <Link  className="text-indigo-400 hover:text-indigo-300 font-medium hover:underline transition-colors">
            Register here
          </Link>
        </div>
